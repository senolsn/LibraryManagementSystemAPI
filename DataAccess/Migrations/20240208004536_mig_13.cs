    ...
    public partial class mig13 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DepartmentUsersUserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    UserDepartmentsDepartmentId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentUser", x => new { x.DepartmentUsersUserId, x.UserDepartmentsDepartmentId });
                    table.ForeignKey(
                        name: "FK_DepartmentUser_Departments_UserDepartmentsDepartmentId",
                        column: x => x.UserDepartmentsDepartmentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentUser_UserDepartmentsDepartmentId",
